"""
Sweep embed_dim in {32, 64, 128} for the SBM-only GNN (gnn_gw_sbm_only.py).
Dataset is generated ONCE and shared across all runs for good comparison.
"""
...
def plot_results(results, out_path):
    ...
    fig.suptitle(f"SBM-only GNN (n_pairs={N_PAIRS_TRAIN})",
...
def main():
    ...
    plot_results(results, "sweep_embed_dim_sbm.png")
